package com.eikmeng.lab4_4_network;
...
public class MainActivity extends AppCompatActivity {
    public static final String TAG = "com.eikmeng.lab4_4_network";
    ListView listViewCourse;
    List<Course> caList;
    private ProgressDialog pDialog;
    //TODO: Please update the URL to point to your own server
    private static String GET_URL = "https://eikeikmengmeng.000webhostapp.com/select_course.php";
    RequestQueue queue;
